...
# Training command
CONFIG="src/hepattn/experiments/tide/configs/tagging/base.yaml"
PYTORCH_CMD="python src/hepattn/experiments/tide/main.py fit -c $CONFIG -c src/hepattn/experiments/tide/configs/tagging/sudo.yaml"
