...
# Training command
CONFIG="src/hepattn/experiments/trackml/configs/tracking.yaml"
PYTORCH_CMD="python src/hepattn/experiments/trackml/main.py fit --config $CONFIG --trainer.devices 1"
