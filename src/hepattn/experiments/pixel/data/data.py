...
class PixelClusterDataModule(DataModuleWrapper):
    ...
    def make_dataset(self, dirpath: str, num_events: int, split: str) -> PixelClusterDataset:
        return PixelClusterDataset(dirpath=dirpath, num_clusters=num_events, **self.kwargs)

    def get_dataloader(self, dataset: PixelClusterDataset, *, shuffle: bool) -> DataLoader:
        return DataLoader(
            dataset=dataset,
