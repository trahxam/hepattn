...
# Training command
CONFIG="src/reconstruct_anything/experiments/pixel/configs/base.yaml"
PYTORCH_CMD="python src/reconstruct_anything/experiments/pixel/main.py fit --config $CONFIG"
