...
# Training command
CONFIG="src/reconstruct_anything/experiments/tide/configs/tagging/base.yaml"
PYTORCH_CMD="python src/reconstruct_anything/experiments/tide/main.py fit -c $CONFIG -c src/reconstruct_anything/experiments/tide/configs/tagging/sudo.yaml"
