...
from reconstruct_anything.experiments.atlas_muon.data import AtlasMuonDataModule
...
def main():
    ...
    parser.add_argument(
        ...
        "-c",
        type=str,
        default="/shared/tracking/hepattn_muon/src/reconstruct_anything/experiments/atlas_muon/configs/NGT/atlas_muon_event_NGT_plotting.yaml",
