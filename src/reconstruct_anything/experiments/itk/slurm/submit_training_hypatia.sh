...
# Training command
CONFIG="src/reconstruct_anything/experiments/itk/configs/filtering_pixel.yaml"
PYTORCH_CMD="python src/reconstruct_anything/experiments/itk/main.py fit --config $CONFIG"
