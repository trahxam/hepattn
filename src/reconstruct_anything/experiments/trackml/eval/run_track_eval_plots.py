...
tracking_fnames = {
    "Paper": "/data/atlas/users/slin/hepattn/src/reconstruct_anything/experiments/trackml/logs/epoch=028-val_loss=1.29786__test_test.h5",
    "TRK-v0 0.9 GeV": "/data/atlas/users/slin/myHepattn/hepattn/src/reconstruct_anything/experiments/trackml/logs/TRK-v0-full_20250906-T205842/\
        ckpts/epoch=029-val_loss=50.09092_test_eval.h5",
    "trackml 1 GeV": "/data/atlas/users/slin/hepattn/src/reconstruct_anything/experiments/trackml/logs/trackml_tracking_20250711-T162137/\
        ckpts/epoch=029-val_loss=12.68400_test_eval.h5",
    "trackml 0.6 GeV": "/data/atlas/users/slin/hepattn/src/reconstruct_anything/experiments/trackml/logs/trackml_tracking_20251103-T102312/\
