...
with pathlib.Path("/data/atlas/users/slin/myHepattn/hepattn/src/reconstruct_anything/experiments/trackml/configs/filtering.yaml").open() as f:
    fconfig = yaml.safe_load(f)

filtering_configs = {"0.9 GeV": fconfig}

filtering_fnames = {
    "0.9 GeV": "/data/atlas/users/slin/myHepattn/hepattn/src/reconstruct_anything/experiments/trackml/"
