...
# Training command
CONFIG="src/reconstruct_anything/experiments/cld/configs/tracking.yaml"
PYTORCH_CMD="python src/reconstruct_anything/experiments/cld/main.py fit --config $CONFIG"
