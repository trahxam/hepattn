...
# Training command
CONFIG="src/reconstruct_anything/experiments/colliderml/configs/base.yaml"
PYTORCH_CMD="python src/reconstruct_anything/experiments/colliderml/main.py fit --config $CONFIG"
