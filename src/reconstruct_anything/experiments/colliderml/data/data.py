...
class ColliderMLDataModule(DataModuleWrapper):
    ...
    def make_dataset(self, dirpath: str, num_events: int, split: str) -> ColliderMLDataset:
        return ColliderMLDataset(dirpath=dirpath, num_events=num_events, **self.kwargs)
